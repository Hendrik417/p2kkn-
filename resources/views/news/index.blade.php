        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="py-12">
                <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    @if (session('success'))
                        <div class="mb-5" role="alert">
                            <div class="bg-cernelian-500 text-white font-bold rounded-t px-4 py-2">
                                Berhasil
                            </div>
                            <div
                    ...
                    <div class="mb-10">
                        <a href="#"
                            class="bg-red-500 hover:bg-green-700 text-white font-bold py-3 px-4 rounded shadow-lg">+
                            Berita</a>
                    </div>
