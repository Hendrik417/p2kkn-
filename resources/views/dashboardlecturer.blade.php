                ...
                <nav class="flex-1 px-4">
                    <div class="mb-6">
                        ...
                        <a href="{{ route('dosen.dashboard') }}"
                            class="flex items-center gap-3 px-3 py-2 {{ request()->routeIs('dosen.dashboard') ? 'bg-indigo-50 text-indigo-600' : 'text-gray-500' }} rounded-lg font-medium shadow-sm transition">
